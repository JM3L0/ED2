...
int main()
{
    ...
    const char *comando = "gcc -o arvore_VP ../Arv_VP_C/main_VP.c ../Arv_VP_C/CEPs.c ../Arv_VP_C/Cidades.c ../Arv_VP_H/STRUCTS.h ../Arv_VP_C/interface.c ../Arv_VP_C/Estados.c ../Arv_VP_C/utilitarios.c ../Arv_VP_C/Pessoas.c -I Arv_VP_H";
    //../Arv_VP_C/main_VP.c
